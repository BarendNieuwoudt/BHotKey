...
Note: this must be a link that starts with "www".
...
Note: The path must be absolute, and have forward slashes / and NOT back slashes \.
...
A template does not have to include %clip% or %high%. These are optional. 
Template configuration must include a key. 
